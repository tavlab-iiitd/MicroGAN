...
def main(root, device):
    ...
    rawdataset = CustomDataset(data, scale=True)
    ...
    G = Generator(noise_input_size+1, inflate_to_size, gex_size).cuda()
    D = Discriminator(gex_size*2, gex_size, disc_internal_size, 1).cuda()
