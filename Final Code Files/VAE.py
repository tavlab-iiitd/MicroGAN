...
"""# Dataset"""
# group1 = pd.read_csv('../../saad18409/Group1Data.csv')
# data = np.random.randn(34602, 83)   # n_genes_patients
# class CustomDataset(Dataset):
#     def __init__(self, actual, shuffle=True, scale=True):
...
#         self.original_dim = self.df.shape[1]
#         if scale:
#             scaler = MinMaxScaler()
...
def main(root, gen_counter, doPca, doMinMax):
    ...
    origpath = root
    print(origpath)
    genpath = os.path.join("./", "gen_final_org" + str(gen_counter))
    modelpath = os.path.join("./", "model_final_org" + str(gen_counter))
    plotpath = os.path.join("./", "plot_final_org" + str(gen_counter))
...
if __name__ == "__main__":
    ...
    roots = sorted(glob.glob("/home/ayushig/saad18409/Group*Axes.csv"))
    gen_counter = 0
    roots = roots[:2]
    print(roots)
    for root in roots:
